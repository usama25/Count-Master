...
namespace MoreMountains.NiceVibrations
{
	...
	public static class MMVibrationManager
	{
        ...
        public static bool GetHapticsState()
        {
            return _vibrationsActive;
        }

        public static void ToggleHapticsActive()
        {
            _vibrationsActive = !_vibrationsActive;
            if (_vibrationsActive)
            {
                MMVibrationManager.StopContinuousHaptic(true);
            }

            DebugLog("[MMVibrationManager] Set haptics active : " + _vibrationsActive);
        }
